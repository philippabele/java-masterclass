...
public class Exercise10 {
    ...
    public static void printYearsAndDays(long minutes) {
        ...
        long minutesOrigin = minutes;
        long minutesRemainder = 0;
        long hoursRemainder = 0;
        long daysRemainder = 0;
        long yearsRemainder = 0;
        ...
        hoursRemainder = minutes % (24 * 60);
        minutes -= hoursRemainder;

        daysRemainder = minutes % (24 * 60 * 365);
        minutes -= daysRemainder;

        yearsRemainder = minutes;

        System.out.println(minutesOrigin + " min = "
                + (yearsRemainder / (24 * 60 * 365)) + " y and "
                + (daysRemainder / (24 * 60)) + " d");
    }
}
