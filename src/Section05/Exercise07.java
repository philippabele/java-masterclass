...
public class Exercise07 {
    ...
    public static void main(String[] args) {
        System.out.println(hasEqualSum(1, 1, 1) + " should return false since 1 "
                + "+ 1 is not equal to 1");
        System.out.println(hasEqualSum(1, 1, 2) + " should return true since 1 + 1"
                + " is equal to 2");
        System.out.println(hasEqualSum(1, -1, 0) + " should return true since 1 + (-1)" +
